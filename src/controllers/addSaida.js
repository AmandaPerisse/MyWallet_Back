...
export async function addSaida(req, res) {
    ...
    const { authorization } = req.headers;
        ...
        if (!session) {
            ...
            await collection.insertOne({userId: id, date: req.body.date, value: req.body.value, description: req.body.description, type: "saida"});
